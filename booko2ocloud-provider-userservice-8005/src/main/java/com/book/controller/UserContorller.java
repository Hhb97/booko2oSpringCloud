...
public class UserContorller {
    ...
    @ResponseBody
    public ServerResponse login(@RequestBody User user, HttpSession session, HttpServletResponse response,HttpServletRequest request){
    	ServerResponse serverResponse = null;
    	try {
		 serverResponse =  userService.login(user.getUsername(),user.getPassword(),response,session);
	} catch (Exception e) {
		// TODO Auto-generated catch block
		System.out.println(this+"jwt失败");
